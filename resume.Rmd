...
For a longer form version, see my [CV](https://nickstrayer.me/cv/).
...
I have professional experience with the following languages, technologies, and concepts

**Languages:**

- Typescript, Python, R, Rust, C++, GLSL

**Frontend:**

- React, D3.js, three.js, rgl, redux

**Technical strengths:**

- Software architecture, rendering optimization, algorithmic efficiency

**Application types:**

- Data dashboards, Statistical algorithm implementations, Data processing pipelines, IDEs.
